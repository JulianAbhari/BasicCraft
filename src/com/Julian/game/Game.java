...
/**
 * (Nearly) True Multiplayer - 04/19/18
 * -- not ALL the world data is being sent --
 * 
 * World Data Kilobyte - 04/19/18
 * 
 * Multiplayer Tile Alterations - 04/14/18
 * 
 * Simplex, Saving, Loading - 03/17/18
 * 
 * Basic Craft - 11/22/17
 * 
...
public class Game extends Canvas implements Runnable {
	...
	public static final String NAME = "Basic Craft";
